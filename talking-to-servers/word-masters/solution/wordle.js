...
async function init() {
    ...
    async function commit() {
        ...
        // skip this step if you're noe checking for valid words
        isLoading = true
        setLoading(isLoading)
    ...
    function markInvalidWord() {
        ...
        // long enough for the browser to repaint the "invalid class" so we can then add it again
        setTimeout(
...
// this uses regex (the /[a-zA-Z]$/.test(letter)) but don't worry about it
...
// takes an array of letters (like ['E', 'L', 'I', 'T', 'E']) and creates an object out of it (like {E: 2, L:1, T:1}) so we can use that to make sure we get the correct amount of letters marked close instead of just wrong or correct
